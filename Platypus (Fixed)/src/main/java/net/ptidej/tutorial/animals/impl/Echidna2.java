...
public class Echidna2 extends AbstractMammal implements IBird, IMammal {
	private final AbstractBird birdTraits = new AbstractBird(null, null, null, new ReproductionMechanismOviparity()) {
		// Duplicate some methods
		@Override
		...
		public int getEggSize() {
			return Echidna2.this.getEggSize();
		}
	...
	@Override
	public int layEgg() {
		// Reuse net.ptidej.tutorial.animals.impl.AbstractBird.layEgg()
